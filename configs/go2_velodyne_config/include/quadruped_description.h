...
namespace champ
{
    namespace URDF
    {
        ...
        {
      base.lf.hip.setOrigin(0.1934, 0.0465, 0.0, 0.0, 0.0, 0.0);
base.lf.upper_leg.setOrigin(0.0, 0.0955, -0.0, 0.0, 0.0, 0.0);
base.lf.lower_leg.setOrigin(0.0, 0.0, -0.213, 0.0, 0.0, 0.0);
     base.lf.foot.setOrigin(0.0, 0.0, -0.213, 0.0, 0.0, 0.0);

      base.rf.hip.setOrigin(0.1934, -0.0465, 0.0, 0.0, 0.0, 0.0);
base.rf.upper_leg.setOrigin(0.0, -0.0955, -0.0, 0.0, 0.0, 0.0);
base.rf.lower_leg.setOrigin(0.0, 0.0, -0.213, 0.0, 0.0, 0.0);
     base.rf.foot.setOrigin(0.0, 0.0, -0.213, 0.0, 0.0, 0.0);

      base.lh.hip.setOrigin(-0.1934, 0.0465, 0.0, 0.0, 0.0, 0.0);
base.lh.upper_leg.setOrigin(0.0, 0.0955, -0.0, 0.0, 0.0, 0.0);
base.lh.lower_leg.setOrigin(0.0, 0.0, -0.213, 0.0, 0.0, 0.0);
     base.lh.foot.setOrigin(0.0, 0.0, -0.213, 0.0, 0.0, 0.0);

      base.rh.hip.setOrigin(-0.1934, -0.0465, 0.0, 0.0, 0.0, 0.0);
base.rh.upper_leg.setOrigin(0.0, -0.0955, -0.0, 0.0, 0.0, 0.0);
